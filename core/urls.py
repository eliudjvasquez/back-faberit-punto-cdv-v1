...
from puntocdv.api import RegistroPersonaEntradaAPIView, RegistroServolucionAPIView, VentaProductoAPIView
...
urlpatterns = [
    ...
    path('api/venta-producto/', VentaProductoAPIView.as_view(), name='venta-producto'),
